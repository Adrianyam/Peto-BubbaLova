<x-admin-layout>
    ...
    <div class="px-4 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Administrador -->
            <a href="{{ route('admin.administrador.usuarios') }}" class="block p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors">
                ...
                <p class="font-normal text-gray-500">Registrar usuarios.</p>
            </a>

            <!-- Cajeros -->
            <a href="{{ route('admin.cajeros.personal') }}" class="block p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between mb-2">
                ...
                <p class="font-normal text-gray-500">Personal registrado.</p>
            </a>
