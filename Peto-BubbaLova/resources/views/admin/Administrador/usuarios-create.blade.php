<x-admin-layout tittle="Registrar Usuario">
    <div class="px-4 py-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-4xl">
            <form action="{{ route('admin.administrador.usuarios.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" name="age" id="age" min="0" value="{{ old('age') }}"
                               class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
